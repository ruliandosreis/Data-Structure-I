...
void gerenciaTeclado(unsigned char key, int mx, int my) {
    ...
    case '5':
        ...
        desenha();
        break;
    /* Filtro: GlitchRedAndBlue */
    /* Responsável por aplicar o filtro desenvolvido porém com Red e Blue */
    case '6':
        AVISO(Grafico: aplicando o filtro de Glitch Vermelho e Azul.);
        _copiaDaImagem = copiaImagem(_imagem);
        glitchRAB(_imagem);
        _imagemFoiModificada = true;
        AVISO(Grafico: voltei da funcao Glitch Vermelho e Azul.\n);
        opcoes();
        desenha();
        break;
    /* Responsável por aplicar o filtro desenvolvido porém com Red e Blue */
    case '7':
        AVISO(Grafico: aplicando o filtro de Glitch Verde e Magenta.);
        _copiaDaImagem = copiaImagem(_imagem);
        glitchGAM(_imagem);
        _imagemFoiModificada = true;
        AVISO(Grafico: voltei da funcao Glitch Verde e Magenta.\n);
        opcoes();
        desenha();
        break;
    /* Filtro: meuFiltro */
...
void opcoes() {
    printf("Escolha uma opção:\n"
           ...
           " '6' para aplicar o Glitch Vermelho e Azul\n"
           " '7' para aplicar o Glitch Verde e Magenta\n"
